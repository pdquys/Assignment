...
const Footer = () => {
  ...
  return (
    <footer className="bg-white dark:bg-gray-900 pt-16 pb-5 mt-20 border-t border-gray-200 dark:border-gray-700">
          ...
          <div>
            ...
            <ul className="list-none">
              <li className="flex items-start gap-2.5 mb-3 text-sm text-gray-600 dark:text-gray-400">
                <img src={mailIcon} alt="Email Icon" width="16" height="16" className="flex-shrink-0 mt-1" />
                <a href="mailto:company123@gmail.com" className="text-blue-500 hover:text-blue-600 transition-colors">
                  company123@gmail.com
                </a>
              </li>
              <li className="flex items-start gap-2.5 mb-3 text-sm text-gray-600 dark:text-gray-400">
                <img src={phoneIcon} alt="Phone Icon" width="16" height="16" className="flex-shrink-0 mt-1" />
              ...
              <li className="flex items-start gap-2.5 text-sm text-gray-600 dark:text-gray-400">
                <img src={mapIcon} alt="Location Icon" width="16" height="16" className="flex-shrink-0 mt-1" />
                <a 
